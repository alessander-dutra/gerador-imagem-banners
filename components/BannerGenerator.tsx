             ...
             <div className="flex items-start gap-4">
               ...
               {!referenceImage ? (
                  <button
                    ...
                    className="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-gray-600 rounded-lg p-4 hover:border-brand-500 hover:bg-gray-700/50 transition-colors text-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent"
                  >
