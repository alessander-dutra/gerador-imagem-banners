                        ...
                        <div className="grid grid-cols-2 gap-3">
                         ...
                         <div>
                            ...
                            <div className="flex bg-gray-900 rounded border border-gray-600">
                                <button onClick={() => setTextAlign('left')} className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 ${textAlign === 'left' ? 'bg-gray-700 text-white' : 'text-gray-400'}`} aria-label="Align text left">
                                ...
                                <button onClick={() => setTextAlign('center')} className={`flex-1 py-1.5 flex justify-center border-l border-r border-gray-600 hover:bg-gray-700 ${textAlign === 'center' ? 'bg-gray-700 text-white' : 'text-gray-400'}`} aria-label="Align text center">
                                ...
                                <button onClick={() => setTextAlign('right')} className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 ${textAlign === 'right' ? 'bg-gray-700 text-white' : 'text-gray-400'}`} aria-label="Align text right">
