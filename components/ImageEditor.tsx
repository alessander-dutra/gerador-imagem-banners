      ...
      <div className="bg-gray-800 w-full max-w-6xl h-[90vh] rounded-2xl overflow-hidden flex flex-col border border-gray-700 shadow-2xl">
        ...
        <div className="p-4 border-b border-gray-700 flex justify-between items-center bg-gray-900">
          ...
          <button
            ...
            className="text-gray-400 hover:text-white p-2 rounded-lg hover:bg-gray-800 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500"
          >
                        ...
                        <div className="grid grid-cols-2 gap-3">
                         ...
                         <div>
                            ...
                            <div className="flex bg-gray-900 rounded border border-gray-600">
                                <button aria-label="Align text left" title="Align Left" onClick={() => setTextAlign('left')} className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 focus:outline-none focus:bg-gray-700 rounded-l ${textAlign === 'left' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
                                ...
                                <button aria-label="Align text center" title="Align Center" onClick={() => setTextAlign('center')} className={`flex-1 py-1.5 flex justify-center border-l border-r border-gray-600 hover:bg-gray-700 focus:outline-none focus:bg-gray-700 ${textAlign === 'center' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
                                ...
                                <button aria-label="Align text right" title="Align Right" onClick={() => setTextAlign('right')} className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 focus:outline-none focus:bg-gray-700 rounded-r ${textAlign === 'right' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
                                ...
                                {!watermarkImage ? (
                                    ...
                                    <div className="relative group rounded-lg border border-gray-700 bg-gray-900 p-2 flex items-center gap-3">
                                        ...
                                        <button 
                                            ...
                                            className="p-1 text-gray-500 hover:text-red-500 transition-colors focus:outline-none focus:ring-2 focus:ring-red-500 rounded"
                                        >
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
