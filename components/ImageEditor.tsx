                         ...
                         <div>
                            ...
                            <div className="flex bg-gray-900 rounded border border-gray-600">
                                <button
                                    ...
                                    className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 ${textAlign === 'left' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}
                                    title="Align left"
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-1.5 flex justify-center border-l border-r border-gray-600 hover:bg-gray-700 ${textAlign === 'center' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}
                                    title="Align center"
                                ...
                                <button
                                    ...
                                    className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 ${textAlign === 'right' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}
                                    title="Align right"
