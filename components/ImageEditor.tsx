                        ...
                        <div className="grid grid-cols-2 gap-3">
                         ...
                         <div>
                            ...
                            <div className="flex bg-gray-900 rounded border border-gray-600">
                                <button title="Align Left" aria-label="Align text left" onClick={() => setTextAlign('left')} className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 ${textAlign === 'left' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
                                ...
                                <button title="Align Center" aria-label="Align text center" onClick={() => setTextAlign('center')} className={`flex-1 py-1.5 flex justify-center border-l border-r border-gray-600 hover:bg-gray-700 ${textAlign === 'center' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
                                ...
                                <button title="Align Right" aria-label="Align text right" onClick={() => setTextAlign('right')} className={`flex-1 py-1.5 flex justify-center hover:bg-gray-700 ${textAlign === 'right' ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
                ...
                {['Zoom', 'Brightness', 'Contrast', 'Saturation', 'Grayscale', 'Sepia'].map(label => {
                  ...
                  return (
                    <div key={label}>
                      ...
                      <input type="range" aria-label={label} min={min} max={max} step={step} value={val} onChange={(e) => setter(Number(e.target.value))} className="w-full h-1 bg-gray-600 rounded-lg appearance-none cursor-pointer accent-brand-500"/>
                    </div>
                  );
                })}
              </div>
